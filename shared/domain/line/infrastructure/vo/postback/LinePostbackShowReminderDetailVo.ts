...
export class LinePostbackShowReminderDetailVo extends LinePostbackVo {
	...
	static create(params: { data?: string; userId?: string; replyToken?: string }): LinePostbackShowReminderDetailVo {
		// 共通フィールドのバリデーション
		...
		return new LinePostbackShowReminderDetailVo(params.data!, params.userId!, params.replyToken!, groupId);
	}
}
