...
export class LineWebhookRequestVo {
	...
	static async createFromRequest(
		...
		// 署名検証
		const signatureVo = await LineWebhookSignatureVo.createFromRequest(
			request,
	...
	getUserId(): string | undefined {
		return this.event.source?.type === "user" || this.event.source?.type === "group"
